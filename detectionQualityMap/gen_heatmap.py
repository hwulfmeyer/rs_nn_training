...
try:
    ...
    heatmap = np.zeros((int(1200 * downscaling_factor), int(1600 * downscaling_factor)))
...
def save_state():
    ...
    while(True):
        heatmap[int(current_y * downscaling_factor), int(current_x * downscaling_factor)] = new_calls
